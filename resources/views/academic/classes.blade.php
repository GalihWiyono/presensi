            ...
            <div class="">
                <form action="/dashboard/academic/class">
                    <div class="input-group">
                        <input type="search" id="search" name="search" class="form-control" placeholder="Search Class"
                    ...
                    <tbody>
                        @foreach ($kelas as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm px-3" id="detailKelas" href="/dashboard/academic/class/{{ $item->id }}"><span data-feather="eye"></span></a>
