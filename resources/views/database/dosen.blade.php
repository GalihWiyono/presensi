...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">{{ __("Lecturers Database") }}</h1>
    </div>
    ...
    <div class="body-white border rounded shadow">
        <div class="container mt-3">
            <div class="d-flex justify-content-between mb-3">
                    ...
                    <form action="/dashboard/database/dosen">
                        <div class="input-group">
                            <input type="search" id="search" name="search" class="form-control"
                                placeholder="{{ __("Search Lecturer") }}" value="{{ request('search') }}" />
                ...
                <div class="">
                    <a class="btn btn-primary px-4" data-bs-toggle="modal" data-bs-target="#tambahdosenModal">{{ __("Upload Lecturer") }}</a>
                    <a class="btn btn-success px-4" href="/dashboard/database/dosen/export">{{ __("Download Lecturer") }}</a>
                </div>
            </div>
    ...
    <div class="modal fade" id="tambahdosenModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="/dashboard/database/dosen/import" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __("Upload Lecturer Master Data") }}</h5>
            ...
            <div class="modal-content">
                <form action="/dashboard/database/dosen" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <span class="text-danger">The deleted data cannot be recovered. Be careful when performing this
                            action!</span>
                        <div class="form-floating mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="/dashboard/database/dosen/changePassword" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __("Change Lecturer Password") }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="student_password">{{ __("Lecturer New Password") }}</label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __("Close") }}</button>
